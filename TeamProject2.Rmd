...
netimpact = function(conf) {
  t= conf$table
  tp = t[2,2]
  fp = t[2,1]
  fn = t[1,2]
  
  return(scales::dollar(TP_PROFIT*tp - FP_COST*fp - FN_COST*fn))
}

sumtable = function(conf_list, leveltwo = FALSE) {
  ...
  if (leveltwo) {
    n = nrow(df)
    kb = kb |>
      kableExtra::group_rows("Level 1", 1, n - 1) |>
      kableExtra::group_rows("Level 2", n, n)
  }
